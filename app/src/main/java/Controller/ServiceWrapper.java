...
import com.example.smartcanteen.BuildConfig;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;

import java.util.concurrent.TimeUnit;

import APISet.ServiceInterface;
import ResponseModel.TokenRes;
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://192.168.0.111/smart_canteen/")
        ...
        public Call<TokenRes.Token_Res> getTokenCall(String code, String mid, String order_id, String amount) {
        ...
        // convert a param into plain text
